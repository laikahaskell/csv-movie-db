...
- `csv-movie-db.php`, when loaded, will read `movies.csv` and render it into a table, ready for [Datatables](https://datatables.net/). 
    - A sample `index.php` page has been provided, which the user can customize. It uses Datatables to display the content loaded by the script.
...
### Uses:
- [Bootstrap](https://getbootstrap.com) and [Datatables](https://datatables.net/) (Index demo page only)
